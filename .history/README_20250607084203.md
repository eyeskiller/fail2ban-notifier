...
```bash
curl -fsSL https://raw.githubusercontent.com/eyeskiller/fail2ban-notifier/main/install.sh | sudo bash
```
...
wget https://github.com/eyeskiller/fail2ban-notifier/releases/latest/download/fail2ban-notify-linux-amd64
