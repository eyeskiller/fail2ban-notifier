...
```bash
curl -fsSL https://raw.githubusercontent.com/eyeskiller/fail2ban-notify-go/main/install.sh | sudo bash
```
...
```bash
git clone https://github.com/eyeskiller/fail2ban-notify-go.git
...
wget https://github.com/eyeskiller/fail2ban-notify-go/releases/latest/download/fail2ban-notify-linux-amd64
