...
echo ""
echo "Run the setup wizard to configure everything interactively:"
echo "  sudo fail2ban-notify -setup"
echo ""
echo "Or configure manually:"
echo "  1. Edit /etc/fail2ban/fail2ban-notify.json to enable connectors"
echo "  2. Test your configuration: sudo fail2ban-notify -status"
